...
//
//@Autonomous(name = "BLUE_Preloads", group = "Autonomous")
//@Configurable
//public class BLUE_Preloads extends CommandOpMode {
...
//        shooter = new ShooterBKP(robotMap, () -> follower.getPose(), DecodeRobot.Alliance.BLUE, telemetry);
