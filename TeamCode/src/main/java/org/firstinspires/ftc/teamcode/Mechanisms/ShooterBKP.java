...
//
//@Config
//public class ShooterBKP extends SubsystemBase {
//    private double SHOOTER_MAX_POWER = 1.0;
//    private final MotorExEx wheel1, wheel2, turretMotor;
//    private ServoImplEx hoodServo, shooterFinger; // Park: 0.975, Block: 0.755
//
...
//
//    private static final double MIN_HOOD = 0.9, MAX_HOOD = 0.45;
//
...
//
//    public ShooterBKP(RobotMap robotMap, Supplier<Pose> curPose, DecodeRobot.Alliance alliance, Telemetry telemetry) {
...
//        hoodServo.setPosition(Range.scale(0, 0, 1, MIN_HOOD, MAX_HOOD));
//
//        this.shooterFinger = robotMap.getShooterFinger();
//        shooterFinger.setPosition(0.975);
//
...
////        hoodServo.setPosition(Range.scale(customHoodPosition, 0, 1, MIN_HOOD, MAX_HOOD));
//
////        turretController.setSetPoint(Range.clip(wheelsEnabled ? getAngleToGoal() : 0, -60, 60));
...
//        return getTurretAngle() > -60 && getTurretAngle() < 60;
//    }
//
//
//    // IK Stuff
